...
if len(sys.argv) != 12:
	print("\n\tsubmit_simulations_2pop.py [outgroup] [nmultilocus] [iteration] [model: SI_x AM_x IM_x SC_x PSC_x PAM_x] [nameA] [nameB] [sub_dir_sim] [sub_dir_model] [config_yaml] [project's directory name, i.e, timeStamp] [binpath]")
	print("\n\tex: submit_simulations_2pop_popGrowth.py 0 1000 2 SI_1N flo mal sim_SI_1N SI_1N config.yaml Ng4PymB1dy beta\n\tto simulate 1000 multilocus simulations at the second iteration, in the folder sim_SI_1N") 
	sys.exit(0)
...
mscommand = ""
if "SI" in model:
	mscommand = "-s tbs -r tbs tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -en tbs 1 tbs -en tbs 2 tbs -ej tbs 2 1 -eN tbs tbs"
if "AM" in model:
...
if "PAN" in model:
	mscommand = "-s tbs -r tbs tbs -eN 0 tbs -eN tbs tbs"
