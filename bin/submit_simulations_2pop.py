...
path = os.getcwd() + '/{0}/{0}'.format(timeStamp)
#path = os.getcwd() 
print(path)
...
mscommand = ""
if "SI" in model:
	mscommand = "-s tbs -r tbs tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -ej tbs 2 1 -eN tbs tbs"
if "AM" in model:
	mscommand = "-s tbs -r tbs tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -ema tbs 2 0 tbs tbs 0 -ej tbs 2 1 -eN tbs tbs"
if "SC" in model:
	mscommand = "-s tbs -r tbs tbs -I 2 tbs tbs 0 -m 1 2 tbs -m 2 1 tbs -n 1 tbs -n 2 tbs -ema tbs 2 0 0 0 0 -ej tbs 2 1 -eN tbs tbs"
if "IM" in model:
	mscommand = "-s tbs -r tbs tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -m 1 2 tbs -m 2 1 tbs -ej tbs 2 1 -eN tbs tbs"
...
tmp += "python3 {0}/priorgen_2pop.py {1} {2} {3} | java -jar {0}/msms3.2rc-b163.jar tbs {4} {5} | pypy {0}/mscalc_2pop_SFS.py {6}".format(binpath, model, nmultilocus, config_yaml, nmultilocus*nlocus, mscommand, outgroup)
